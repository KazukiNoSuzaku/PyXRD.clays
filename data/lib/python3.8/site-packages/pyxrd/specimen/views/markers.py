...
class EditMarkerView(BaseView):
    builder = resource_filename(__name__, "../ui/edit_marker.ui")
    top = "edit_marker"
...
class EditMarkersView(ObjectListStoreView):
    extra_widget_builder = resource_filename(__name__, "../ui/find_peaks.ui")
...
class MatchMineralsView(DialogView):
    ...
    subview_builder = resource_filename(__name__, "../ui/match_minerals.ui")
...
class DetectPeaksView(DialogView):
    ...
    subview_builder = resource_filename(__name__, "../ui/find_peaks_dialog.ui")
    ...
    def setup_matplotlib_widget(self):
        ...
        self.matlib_canvas = FigureCanvas(self.figure)

...
<ui version="4.0">
 <class>smooth_data</class>
 <widget class="QWidget" name="smooth_data">
  ...
  <layout class="QGridLayout" name="smooth_grid">
   ...
   <item row="0" column="1">
    <widget class="QComboBox" name="smooth_type"/>
   </item>
   ...
   <item row="2" column="0">
    <widget class="QLabel" name="lbl_degree">
     <property name="text"><string>Window size</string></property>
     <property name="alignment"><set>Qt::AlignRight|Qt::AlignVCenter</set></property>
    </widget>
   </item>
   <item row="2" column="1">
    <widget class="QSpinBox" name="spin_degree">

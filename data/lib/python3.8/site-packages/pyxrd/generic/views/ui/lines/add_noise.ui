...
<ui version="4.0">
 <class>add_noise</class>
 <widget class="QWidget" name="add_noise">
  <property name="minimumWidth"><number>320</number></property>
  <layout class="QGridLayout" name="noise_grid">
   ...
   <item row="0" column="0">
    <widget class="QLabel" name="lbl_value">
     <property name="text"><string>Fraction</string></property>
     <property name="alignment"><set>Qt::AlignRight|Qt::AlignVCenter</set></property>
    </widget>
   </item>
   <item row="0" column="1">
    <widget class="QDoubleSpinBox" name="spin_fraction">
     ...
     <property name="value"><double>0.1</double></property>
